                ...
                <form className="form" action="#" onSubmit={save}>
                    ...
                    <div className="row-content">
                        ...
                        <div className="profile-radio-button">
                            ...
                            <label >
                                <input type="radio" name="profileUrl" checked={formValue.profileUrl === '../../assets/profile-images/Ellipse 2.png'} value="../../assets/profile-images/Ellipse -2.png" onChange={changeValue} />
                            ...
                            <label >
                                <input type="radio" name="profileUrl" checked={formValue.profileUrl === '../../assets/profile-images/Ellipse -4.png'} value="../../assets/profile-images/Ellipse -4.png" onChange={changeValue} />
